...
const LineRateItem = ({ lineConfig, selectedDate, selectedShift, onDataLoaded }) => {
    ...
    const {
        ...
        accGoal,
        loading
    } = useProductionDataLite(selectedDate, apiConfig, lineConfig.lineNo, 'basic');
    ...
    }, [loading, totalDia, accGoal, onDataLoaded, lineConfig.id, lineConfig.lineNo]);
