...
import SelectorLinea from '../components/filtros/Lineas';
...
const TablaProdCdu = () => {
    ...
    const fetchAndSyncData = useCallback(async () => {
        ...
        try {
            ...
            setError("Se perdió la conexión con el API.");
        }
    ...
    return (
        <div className="bodyTablaCDU">
            ...
            {error && (
                <div style={{ backgroundColor: '#ffebee', color: '#c62828', padding: '12px', textAlign: 'center', fontWeight: 'bold', border: '1px solid #ef9a9a', margin: '10px 20px', borderRadius: '5px', fontSize: '1.1rem' }}>
                    ⚠️ {error}
                </div>
            )}
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    <td>Línea:</td>
                                    <td>
                                        {/* AQUI SE MANDA LLAMAR EL COMPONENTE DE LAS LINEAS MI SEAN */}
                                        <SelectorLinea lineaActual="0" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
